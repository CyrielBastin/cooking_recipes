class CreateCategoryNameTranslationsForMobilityTableBackend < ActiveRecord::Migration[6.1]
  def change
  ...
  add_index :category_translations, [:name, :locale], name: :index_category_translations_on_name_and_locale
  end
end
