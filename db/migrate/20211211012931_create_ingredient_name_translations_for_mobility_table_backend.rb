class CreateIngredientNameTranslationsForMobilityTableBackend < ActiveRecord::Migration[6.1]
  def change
  ...
  add_index :ingredient_translations, [:name, :locale], name: :index_ingredient_translations_on_name_and_locale
  end
end
